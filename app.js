      ...
      return `<tr>
        ...
        <td data-label="Actions" class="no-print">
          <div class="row-actions">
            ${canStaffSign ? `<button class="btn ghost small" onclick="openCanvasModal('${entry.id}','staff')">✍️ Staff Sign Canvas</button>` : ''}
...
function openCanvasModal(entryId, kind) {
  ...
  <div class="overlay">
    <div class="modal" style="max-width:440px;">
      <h3>${isPi ? 'PI Approval Signature Canvas' : 'Staff Signature Canvas Pad'}</h3>
      <div class="modal-sub">Draw signature using finger, mouse, or touch stylus.</div>
      ...
      <div class="field">
        <label>Signature Box (Canvas Pad)</label>
